...
def embed_jotform_iframe():
    iframe = """
    <iframe
      id="JotFormIFrame-233385865863067"
      title="Controle de Procedimentos - RIVOA"
      onload="window.parent.scrollTo(0,0)"
      allowtransparency="true"
      allowfullscreen="true"
      allow="geolocation; microphone; camera"
      src="https://form.jotform.com/233385865863067"
      frameborder="0"
    ...
    var ifr = document.getElementById("JotFormIFrame-233385865863067");
    if (ifr) {
      var src = ifr.src;
      var iframeParams = [];
